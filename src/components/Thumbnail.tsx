...
export default function Thumbnail({ movie }: { movie: Movie }) {
  return (
    <Card
      className="relative group h-48 min-w-[240px] w-[240px] md:[300px] overflow-hidden cursor-pointer transition duration-100 ease-out  md:min-w-[300px] md:hover:scale-105"
      onClick={() => {}}
    >
